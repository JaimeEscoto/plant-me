...
const { toCatalogMap, buildAccessoryList } = require('../utils/accessories');
...
exports.purchaseAccessory = async (req, res, next) => {
  try {
    ...
    const accessories = buildAccessoryList(refreshedInventory.inventario);
    const enrichedGarden = garden ? { ...garden, accesorios: accessories } : garden;
